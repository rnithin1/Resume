...
\begin{document}
	...
	\vspace{-20pt}
		...
		{\bf $\rightarrow$ Samsung Advanced Computing Lab} \hfill \emph{May 2019 -- Present} \\
        \vspace{-10pt}
        \begin{itemize}
%            \item Conducted extensive research on deep learning usecases and models as part of Samsung's GPU team
            \item Analyzed several deep learning models for routes of optimization and quantization
%            \item Wrote and implemented OpenCL and OpenGL code 
            ...
            \item Wrote and trained a neural network to perform ambient occlusion on complex scenes rendered with OpenGL
            \item Modified and trained a neural network based on InstaGAN that converts a flat-rendered scene to a realistic, physically based rendered one  
        \end{itemize}
		\vspace{-10pt}
